<%-- 
    Document   : vendors
    Created on : Apr 9, 2015, 8:35:12 PM
    Author     : Vineet
--%>
    ...
    <body>
        ...
        <div class="container-fluid">
                ...
                <div id="content" class="span10">
                    ...
                    <div>
                        <ul class="breadcrumb">
                            ...
                            <li>
                                <a href="${pageContext.request.contextPath}/admin/vendors.htm">Vendors</a>
                            </li>
                        </ul>
                    </div>
                        ...
                        <div>
                            <div class="box-content alerts" id="popup">
                                <div class="alert alert-success">
                                    ...
                                    <strong>New Vendor has been added.</strong>
                                </div>
                            </div>
                        </div>
                    </c:if>
                        ...
                        <div>
                            <div class="box-content alerts" id="popup">
                                <div class="alert alert-error">
                                    <button type="button" class="close" data-dismiss="alert">×</button>
                                    <strong>Could not add Vendor. Vendor with the same name exists in the system.</strong>
                                </div>
                            </div>
                        </div>
                    </c:if>
                    ...
                    <div class="row-fluid sortable">
                        <div class="box span12">
                            <div class="box-header well" data-original-title>
                                <h2><i class="icon-plus"></i> Vendors</h2>
                                <div class="box-icon">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <c:forEach var="enterprise" items="${requestScope.enterpriseList}">
                                            <tr>
                                                <td><a href="${pageContext.request.contextPath}/admin/vendors/view.htm?eid=${enterprise.id}">${enterprise.number}</a></td>                                      
                                                <td>${enterprise.name}</td>                                      
                                                <td>${counties.get(enterprise.countyId)}</td>                                            
                                                <td>
                                                    <a href="${pageContext.request.contextPath}/admin/vendors/edit.htm?eid=${enterprise.id}" title="Edit"><span class="icon icon-color icon-edit"></span></a>
                                                </td>                                      
                                            </tr>
                                        </c:forEach>
            ...
            <div class="modal hide fade" id="myModal">
                ...
                <spring:form action="${pageContext.request.contextPath}/admin/vendors/add.htm" commandName="enterprise" method="POST" cssClass="form-horizontal" onsubmit="return validateEnterprise();">
