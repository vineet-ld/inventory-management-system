                ...
                <div id="content" class="span10">
                    ...
                    <div>
                        <ul class="breadcrumb">
                            ...
                            <li>
                                <a href="${pageContext.request.contextPath}/users.htm">Users</a> <span class="divider">/</span>
                            </li>
                            <li>
                                <a href="${pageContext.request.contextPath}/users/view.htm?uid=${user.id}">${user.firstName}&nbsp;${user.lastName}</a>
                            </li>
                        </ul>
                    </div>
